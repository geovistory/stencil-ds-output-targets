import { prepareFile } from '../src/output-happy-dom'
describe('createHappyDomWorker', () => {
  it('should create a HappyDOM worker', () => {
...
const start = async () => {
  const { defineCustomElements } = await import('@my-company/my-components/loader')
